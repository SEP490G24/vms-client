            ...
            <Card className={'bg-body'}>
              <Space className={'w-full justify-between'} direction={'horizontal'} align={'center'}>
                <Statistic title={<span dangerouslySetInnerHTML={{ __html: props.successLabel }} />}
                           ...
                           formatter={formatter} />
                <p
                  className={'lg:w-[97px] 2xl:w-[120px] px-4 py-2 text-white bg-gray-400 rounded'}>In {props.filterLabel}: {props.successWithCondition}</p>
              </Space>
            </Card>
          </Col>
          <Col xl={9} xxl={8}>
            <Card className={'bg-body'}>
              <Space className={'w-full justify-between'} direction={'horizontal'} align={'center'}>
                <Statistic title={<span dangerouslySetInnerHTML={{ __html: props.failedLabel }} />} value={props.failed}
                           formatter={formatter} />
                <p
                  className={'xl:w-[97px] 2xl:w-[120px] px-4 py-2 text-white bg-gray-400 rounded'}>In {props.filterLabel}: {props.failedWithCondition}</p>
              </Space>
            </Card>
          </Col>
        </Row>
